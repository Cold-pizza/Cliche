import "./style.scss";
import { MusicListIprops } from "../../types";
        ...
        <div id="music-list">
                ...
                return (
                    <section className="item">
                        <div className="sing-info">
                            <div className="image">
                                <img
                                    src={props.musicImg[i]}
                                    alt={props.musicImg[i]}
                                />
                            </div>
                            <div>
                                <p>{title}</p>
                        ...
                        <i
                            className="fas fa-minus remove-btn"
                            onClick={() => {
            ...
            {isBtn ? (
                <div className="panel">
                    ...
                    ></i>
                    <p>
                        제목을 <span>"가수이름"-"노래제목"</span>으로된 파일을
                        업로드해주세요!
                    </p>
                </div>
            ) : null}
